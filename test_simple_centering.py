...
def test_simple_centering():
    """Simple test to verify cube centering between gripper claws"""
    p.connect(p.DIRECT)  # Use DIRECT for quick testing
    ...
    # Load guaranteed gripper with centering
    ...
    print(f"Centering gripper joints: {gripper_joints}")
    ...
    print("Centering gripper attached")
    ...
    def open_gripper():
        ...
        print("Gripper opened for centering")
    ...
    def close_gripper():
        for joint_idx in gripper_joints:
            p.setJointMotorControl2(
                ...
                joint_idx,
                p.POSITION_CONTROL,
                targetPosition=0.006,  # 6mm for centering
                force=5,
                positionGain=0.3
            )
        print("Gripper closed - cube centering")
    ...
    print(f"Centering grasp position: {grasp_position}")
    ...
    # Step 3: Close gripper for centering
    print("Closing gripper for centering...")
    close_gripper()
    
    # Monitor contacts during centering
    print("Monitoring contacts for centering...")
    contact_history = []
    for i in range(100):
        p.stepSimulation()
    ...
    print(f"Max contacts during centering: {max_contacts}")
    ...
    if final_contacts > 0:
        ...
        if lift_height > 0.05:
            ...
            print("✅ Cube properly centered and lifted!")
            success = True
        else:
